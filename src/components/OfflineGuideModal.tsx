...
title 학급 자리배치 시스템 (CSA) - 오프라인 개인 PC 모드
echo ===================================================
echo 학급 자리배치 시스템 (Classroom Seating Arrangement)
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5 space-y-3">
                ...
                <ul className="space-y-2 text-emerald-800 leading-relaxed font-medium">
                  ...
                  <li>
                    ...
                    자리배치 필수/선호 제약조건 판정, 최적 자리배치 알고리즘 계산, 엑셀 출력 및 자리 추첨까지 모든 기능이 외부 서버를 거치지 않고 교사 PC 내부에서 100% 즉시 처리됩니다.
                  </li>
                </ul>
              </div>
            </div>
...
function createWindow() {
  const win = new BrowserWindow({
    width: 1400,
    height: 900,
    title: "Classroom Seating Arrangement (오프라인 실행 모드)",
    webPreferences: {
